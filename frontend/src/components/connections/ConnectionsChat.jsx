...
import { ConnectionsComposer } from "./ConnectionsComposer.jsx";
import { GroupDetailsDrawer } from "./ConnectionsModals.jsx";
import {
...
export function ConnectionsChat({
  activeConversation,
  auth,
  isMobileViewport,
  ...
  const uploadFiles = async (files, resetTarget) => {
    ...
    try {
      for (const file of files) {
        ...
        const uploaded = await uploadFriendshipAttachment(file, {

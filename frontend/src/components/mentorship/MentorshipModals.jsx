    ...
    <div className="member-chat-drawer">
      ...
      <div className="member-chat-drawer-body">
        <p className="member-drawer-help">
          Messages are protected with end-to-end encryption. Only members with the
          conversation key can read them.
        </p>
        ...
        <div className="member-field">
          ...
          <div className="member-encryption-panel-row">
            ...
            <button
              ...
              onClick={() => saveConversationSecret(conversationSecretInput)}
              type="button"
            >
              Save
            </button>
        ...
        <div className="member-drawer-actions">
          ...
          {isE2eeInitializing ? <span className="member-drawer-status">Syncing secure channel...</span> : null}
        </div>
      </div>
    </div>
  );
